...
def main():     
    ...
    y1 = 0
    while ret:
        ret, frame = cap.read()         #reads frame from webcam input
        if ret or image:
            if image:
            ...
            if results.boxes is None:
                ...
                for result in results.boxes.data.tolist():
                    ...
                    blur = cv2.blur(license_plate_thresh, (5,5))
                ...
                #*******************************************
                # Filtering out wrongly read plate numbers 
                if len(license_plate_number_list) > 8:      # Could change parameters according to the fltering intensity
